    ...
    public String handleRequest(URI url) throws IOException {
        ...
        if (url.getPath().equals("/")) {
            ...
            if (parameters[0].equals("q")) {
                ...
                // return all the file paths where the given string is part of the path of the file
                List<String> foundPaths = new ArrayList<> ();
                for (File f: paths) {
                ...
                result = String.join("\n", foundPaths);
                return String.format("Hey, I found %d files with %s in the path:\n%s", foundPaths.size(), parameters[1], result);
            } else {
